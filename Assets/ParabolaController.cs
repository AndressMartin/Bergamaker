...
public class ParabolaController : MonoBehaviour
{
    ...
    //line
    protected ParabolaFly line;
    //line
    protected LineRenderer lineDraw;
    ...
    void LineDraw()
    {
        if (line == null)
        {
            line = new ParabolaFly(ParabolaRoot.transform);
        }
        ...
        for (int c = 1; c <= accur; c++)
        {
            ...
            float mag = (currPos - prevPos).magnitude * 1000;
    ...
    void Start()
    {
        lineDraw = ParabolaRoot.GetComponent<LineRenderer>();
